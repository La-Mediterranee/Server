 ...
 * @return
 */
function verifySignature(signature: Buffer, data: Buffer, publicKey: string): boolean {
 ...
 */
let generateServerGetAssertion = (authenticators: any[]): PublicKeyCredentialRequestOptions => {
