...
export const { WEB_URL, PORT, NODE_ENV, HOSTNAME, ORIGIN } = process.env as Record<string, string>;
...
export const GOOGLE_STORAGE_BUCKET = process.env.GOOGLE_STORAGE_BUCKET as string;
